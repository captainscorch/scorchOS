        ...
        <main class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div ref="demosDropdownRef" class="relative mb-8 w-full md:max-w-xs">
                ...
                >
                    <div
                        ...
                        class="absolute top-full right-0 left-0 z-10 mt-1 max-h-60 w-full overflow-auto rounded-xl border border-neutral-200 bg-white py-1 shadow-lg md:max-w-xs dark:border-white/10 dark:bg-neutral-900 dark:shadow-neutral-950/50"
                    >
                        <button
            ...
            <div class="grid grid-cols-1 gap-12">
                <div
                    ...
                    :key="exp.id"
                    :id="exp.id"
                    class="group relative scroll-mt-32 overflow-hidden rounded-3xl border border-neutral-200 bg-white/50 p-4 backdrop-blur-sm transition-all hover:border-brand-400/30 md:p-6 dark:border-white/10 dark:bg-neutral-900/50"
                >
                    <div class="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-start">
                        <div class="max-w-xl">
                            <div class="mb-3 flex items-center gap-3">
                                <div class="flex size-8 items-center justify-center rounded-lg bg-brand-400/10 text-brand-400">
                                    <FontAwesomeIcon icon="fa-sharp fa-light fa-flask" class="size-4" />
                                </div>
                                <LabelText as="span" size="xs" weight="semibold" class="!text-brand-400">
                                    {{ exp.category }}
                                </LabelText>
                            </div>
