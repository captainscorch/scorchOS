...
const copyToClipboard = async (text: string, type: 'Logo' | 'URL') => {
    try {
        await navigator.clipboard.writeText(text);
        toast.success(t('commandMenu.toast.copied', { type }), {
            description: type === 'URL' ? t('commandMenu.toast.copiedUrlDescription') : t('commandMenu.toast.copiedDescription'),
        });
    } catch {
